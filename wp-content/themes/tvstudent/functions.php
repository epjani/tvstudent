...
/* Register header and main menu locations */
register_nav_menu( 'header', __( 'Header Menu', 'twentyeleven' ) );
register_nav_menu( 'main', __( 'Main Menu', 'twentyeleven' ) );
...
add_theme_support( 'post-thumbnails' );
add_image_size( 'highlight-thumb', 560, 246, true );
set_post_thumbnail_size( 212, 174, true );